...
proc mz_free*(p: pointer)
const 
  MZ_ADLER32_INIT* = (1)

# mz_adler32() returns the initial adler-32 value to use when called with ptr==NULL.

proc mz_adler32*(adler: mz_ulong, pointr: ptr cuchar, buf_len: csize): mz_ulong
const 
  MZ_CRC32_INIT* = (0)

# mz_crc32() returns the initial CRC-32 value to use when called with ptr==NULL.

proc mz_crc32*(crc: mz_ulong; pointr: ptr cuchar; buf_len: csize): mz_ulong
...
when not(defined(MINIZ_NO_ZLIB_APIS)): 
  ...
  type 
    ...
    mz_free_func* = proc (opaque: pointer; address: pointer)
  ...
  proc mz_deflateInit*(pStream: mz_streamp; level: cint): cint
  ...
  proc mz_deflateInit2*(pStream: mz_streamp; level: cint; meth: cint; 
                        window_bits: cint; mem_level: cint; strategy: cint): cint
  # Quickly resets a compressor without having to reallocate anything. Same as calling mz_deflateEnd() followed by mz_deflateInit()/mz_deflateInit2().
  proc mz_deflateReset*(pStream: mz_streamp): cint
  ...
  proc mz_deflate*(pStream: mz_streamp; flush: cint): cint
  # mz_deflateEnd() deinitializes a compressor:
  # Return values:
  #  MZ_OK on success.
  #  MZ_STREAM_ERROR if the stream is bogus.
  proc mz_deflateEnd*(pStream: mz_streamp): cint
  # mz_deflateBound() returns a (very) conservative upper bound on the amount of data that could be generated by deflate(), assuming flush is set to only MZ_NO_FLUSH or MZ_FINISH.
  proc mz_deflateBound*(pStream: mz_streamp; source_len: mz_ulong): mz_ulong
  # Single-call compression functions mz_compress() and mz_compress2():
  # Returns MZ_OK on success, or one of the error codes from mz_deflate() on failure.
  proc mz_compress*(pDest: ptr cuchar; pDest_len: ptr mz_ulong; 
                    pSource: ptr cuchar; source_len: mz_ulong): cint
  proc mz_compress2*(pDest: ptr cuchar; pDest_len: ptr mz_ulong; 
                     pSource: ptr cuchar; source_len: mz_ulong; level: cint): cint
  # mz_compressBound() returns a (very) conservative upper bound on the amount of data that could be generated by calling mz_compress().
  proc mz_compressBound*(source_len: mz_ulong): mz_ulong
  # Initializes a decompressor.
  proc mz_inflateInit*(pStream: mz_streamp): cint
  # mz_inflateInit2() is like mz_inflateInit() with an additional option that controls the window size and whether or not the stream has been wrapped with a zlib header/footer:
  # window_bits must be MZ_DEFAULT_WINDOW_BITS (to parse zlib header/footer) or -MZ_DEFAULT_WINDOW_BITS (raw deflate).
  proc mz_inflateInit2*(pStream: mz_streamp; window_bits: cint): cint
  ...
  proc mz_inflate*(pStream: mz_streamp; flush: cint): cint
  # Deinitializes a decompressor.
  proc mz_inflateEnd*(pStream: mz_streamp): cint
  # Single-call decompression.
  # Returns MZ_OK on success, or one of the error codes from mz_inflate() on failure.
  proc mz_uncompress*(pDest: ptr cuchar; pDest_len: ptr mz_ulong; 
                      pSource: ptr cuchar; source_len: mz_ulong): cint
  # Returns a string description of the specified error code, or NULL if the error code is invalid.
  proc mz_error*(err: cint): cstring
...
when not(defined(MINIZ_NO_ARCHIVE_APIS)): 
  ...
  proc mz_zip_reader_extract_to_mem_no_alloc*(pZip: ptr mz_zip_archive; 
      ...
      pUser_read_buf: pointer; user_read_buf_size: csize): mz_bool
  ...
  when not(defined(MINIZ_NO_ARCHIVE_WRITING_APIS)): 
    ...
    proc mz_zip_writer_init*(pZip: ptr mz_zip_archive; existing_size: mz_uint64): mz_bool
    proc mz_zip_writer_init_heap*(pZip: ptr mz_zip_archive; 
                                  size_to_reserve_at_beginning: csize; 
                                  initial_allocation_size: csize): mz_bool
    when not(defined(MINIZ_NO_STDIO)): 
    ...
    proc mz_zip_writer_add_mem*(pZip: ptr mz_zip_archive; 
                                ...
                                buf_size: csize; level_and_flags: mz_uint): mz_bool
    ...
    proc mz_zip_writer_add_from_zip_reader*(pZip: ptr mz_zip_archive; 
        pSource_zip: ptr mz_zip_archive; file_index: mz_uint): mz_bool
    ...
    proc mz_zip_add_mem_to_archive_file_in_place*(pZip_filename: cstring; 
        ...
        pComment: pointer; comment_size: mz_uint16; level_and_flags: mz_uint): mz_bool
    # Reads a single file from an archive into a heap block.
    # Returns NULL on failure.
    proc mz_zip_extract_archive_file_to_heap*(pZip_filename: cstring; 
        pArchive_name: cstring; pSize: ptr csize; zip_flags: mz_uint): pointer
...
proc tinfl_decompress_mem_to_heap*(pSrc_buf: pointer; src_buf_len: csize; 
                                   pOut_len: ptr csize; flags: cint): pointer
...
type 
  tinfl_put_buf_func_ptr* = proc (pBuf: pointer; len: cint; pUser: pointer): cint
...
proc tdefl_write_image_to_png_file_in_memory_ex*(pImage: pointer; w: cint; 
    h: cint; num_chans: cint; pLen_out: ptr csize; level: mz_uint; flip: mz_bool): pointer
proc tdefl_write_image_to_png_file_in_memory*(pImage: pointer; w: cint; h: cint; 
    num_chans: cint; pLen_out: ptr csize): pointer
# Output stream interface. The compressor uses this interface to write compressed data. It'll typically be called TDEFL_OUT_BUF_SIZE at a time.

type 
  tdefl_put_buf_func_ptr* = proc (pBuf: pointer; len: cint; pUser: pointer): mz_bool
...
proc tdefl_compress*(d: ptr tdefl_compressor; pIn_buf: pointer; 
                     ...
                     pOut_buf_size: ptr csize; flush: tdefl_flush): tdefl_status
# tdefl_compress_buffer() is only usable when the tdefl_init() is called with a non-NULL tdefl_put_buf_func_ptr.
# tdefl_compress_buffer() always consumes the entire input buffer.

proc tdefl_compress_buffer*(d: ptr tdefl_compressor; pIn_buf: pointer; 
                            in_buf_size: csize; flush: tdefl_flush): tdefl_status
proc tdefl_get_prev_return_status*(d: ptr tdefl_compressor): tdefl_status
proc tdefl_get_adler32*(d: ptr tdefl_compressor): mz_uint32
